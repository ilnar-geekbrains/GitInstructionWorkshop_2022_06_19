...
1. Нажать fork на сайте github
2. Скопировать репозиторий через git clone (ссылку)
3. Изменить что-то в файле
4. Сохранить, закомитить, отправить через push
5. Запрос через pull request на github
6. Написать комментарий, что какие мы молодцы, смогли разобраться :)
