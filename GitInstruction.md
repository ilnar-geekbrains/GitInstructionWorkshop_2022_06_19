...
Система контроля версий нужна для хранений разных состояний докумнета, а так же для организации совместной работы над одним проектом группой сотрудников. 
