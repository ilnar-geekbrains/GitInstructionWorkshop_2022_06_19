...
> ветки служат для создания и проработки изменений, наиболее верный способ хранить изменения это делать как можно больше веток.  
> для создания ветки используем команду git brunch + "имя новой ветки"
> для переключения между ветками используем команду git checkout + имя ветки на которую надо переключиться  
> для удаления ветки используем команду git branch -d + имя удаляемой ветки 
> для удаления любой ветки используем команду git branch -D + имя ветки 
