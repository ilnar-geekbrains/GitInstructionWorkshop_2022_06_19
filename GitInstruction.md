 ...
 * Система контроля версия дает возможность хранить различные версии проекта
 * Система контроля версий дает возможность возвращаться к различным версиям проекта
